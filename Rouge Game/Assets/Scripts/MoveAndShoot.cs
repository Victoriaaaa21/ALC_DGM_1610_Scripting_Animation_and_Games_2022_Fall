...
public class MoveAndShoot : MonoBehaviour
{
    ...
    void Update()
    {
       ...
       {
        transform.position = Vector2.MoveTowards(transform.position, target.position, speed *Time.deltaTime); //Moves towards target
       } 
        ...
        {
            shotDelay -= Time.deltaTime; //Counting down
        }
    }
}
